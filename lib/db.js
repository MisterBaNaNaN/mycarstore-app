...
addColumnIfMissing('site_state', 'fidelity_threshold', "fidelity_threshold INTEGER NOT NULL DEFAULT 5");
addColumnIfMissing('site_state', 'fidelity_reward', "fidelity_reward TEXT NOT NULL DEFAULT 'une remise fidélité'");
addColumnIfMissing('site_state', 'overload_threshold', "overload_threshold INTEGER NOT NULL DEFAULT 6");
addColumnIfMissing('communications', 'invoice_id', "invoice_id INTEGER REFERENCES invoices(id) ON DELETE SET NULL");
